...
function Home() {
  ...
  return (
    <>
      <div
        className={` flex flex-col items-center w-[100%] h-[510px] bg-[url(/assets/home/mobile/image-header.jpg)] bg-opacity-100 bg-cover bg-bottom pt-[108px] `}
      >
        <h2 className="text-[#FFF] text-opacity-50 text-[14px] tracking-[10px] mb-[16px] ">
          NEW PRODUCT
        </h2>
        <h1 className="text-[#FFF] text-[36px] text-center font-bold tracking-[1.3] mb-[24px] ">
          XX99 Mark II HeadphoneS
        </h1>
        <p className="text-[#FFF] text-opacity-70 text-[15px] text-center font-medium mb-[28px] ">
      ...
      <section className=" px-[24px] mt-[40px]">
        ...
        <div className=" flex flex-col items-center w-[100%] h-[600px] rounded-[8px] bg-[#D87D4A] mt-[120px] px-[23px] relative overflow-hidden ">
          ...
          <button className="w-[160px] h-[48px] flex items-center justify-center bg-black" onClick={() => navigaton(`/zx9-speaker`)} >
        ...
        >
          ...
          <div className="absolute left-[24px]">
            ...
            <button className=" flex items-center justify-center w-[160px] h-[48px] bg-[transparent] border border-solid border-black " onClick={() => navigaton(`/zx7-speaker`)}>
        ...
        <div>
          ...
          <div className=" flex flex-col justify-center gap-[32px] w-[100%] h-[200px] bg-[#F1F1F1] rounded-[8px] pl-[24px] mt-[24px] ">
            ...
            <button className=" flex items-center justify-center w-[160px] h-[48px] bg-[transparent] border border-solid border-black "  onClick={() => navigaton(`/yx1-earphones`)}  >
              <p className="text-[13px] text-black font-bold ">See Product</p>
            </button>
          </div>
        </div>
